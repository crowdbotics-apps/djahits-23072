"""djahits_23072 URL Configuration
...
admin.site.site_header = "Djahits"
admin.site.site_title = "Djahits Admin Portal"
admin.site.index_title = "Djahits Admin"

# swagger
api_info = openapi.Info(
    title="Djahits API",
    default_version="v1",
    description="API documentation for Djahits App",
)
